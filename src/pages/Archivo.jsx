...
export default function Archivo() {
  return (
    <div className="bg-background text-on-surface font-body selection:bg-primary selection:text-on-primary overflow-x-hidden min-h-screen">
      <main className="pt-24 md:pt-32 pb-16 md:pb-24 px-6 md:px-12 min-h-screen relative">
        ...
        {/* Header */}
        <header className="mb-16 md:mb-24 flex flex-col md:flex-row justify-between items-start md:items-end gap-6 md:gap-8 gsap-fade-in">
          <div className="max-w-4xl">
            <p className="font-mono text-primary text-[10px] tracking-widest mb-3 md:mb-4 uppercase">CATÁLOGO DE INVESTIGACIÓN // NIVEL 4</p>
            <h1 className="text-4xl sm:text-5xl md:text-6xl lg:text-8xl font-headline font-light tracking-[0.1em] text-on-surface leading-tight uppercase">ARCHIVO DE FENÓMENOS</h1>
          </div>
          <div className="hidden md:block font-mono text-[11px] text-on-surface/40 text-right leading-relaxed">
        ...
        <div className="grid grid-cols-1 md:grid-cols-12 gap-8 md:gap-12">
          ...
          {/* Hero Card */}
          <div className="md:col-span-8 group relative overflow-hidden bg-[#0c0e14] gsap-fade-in min-h-[300px] md:min-h-[500px]">
            ...
            <div className="absolute bottom-0 left-0 p-6 md:p-10 w-full flex flex-col gap-6">
              <div>
                <span className="font-mono text-primary text-[10px] block mb-2">[ ANOMALÍA_ALPHA-09 ]</span>
                <h2 className="font-serif text-2xl md:text-4xl font-light mb-3 md:mb-4">Ciclón de Ionización Baja</h2>
                <p className="text-on-surface/70 font-body max-w-md leading-relaxed text-sm hidden sm:block">Vórtice detectado a 32,000 pies. Muestra patrones de rotación no convencionales y emisión de plasma frío en el núcleo.</p>
              </div>
              <div className="glass-panel border border-[rgba(132,149,136,0.2)] p-4 md:p-6 flex flex-col gap-3 md:gap-4 w-full sm:w-auto sm:min-w-[200px] self-start">
          ...
          {/* Side Card */}
          <div className="md:col-span-4 group flex flex-col justify-between border-l border-[rgba(132,149,136,0.2)] pl-8 md:pl-12 gsap-fade-in">
            <div>
              <div className="aspect-square w-full mb-6 md:mb-8 overflow-hidden bg-[#0c0e14]">
                <img
              ...
              <h3 className="font-serif text-xl md:text-2xl font-light mb-3 md:mb-4">Velo de Radiación Estática</h3>
              <p className="text-on-surface/60 font-body text-xs leading-relaxed mb-4 md:mb-6">Interferencia persistente capturada por el sensor Sentinel-4 durante el tránsito del solsticio. Origen desconocido.</p>
            </div>
          ...
          {/* Aurora Card */}
          <div className="md:col-span-5 group relative overflow-hidden bg-[#0c0e14] md:mt-12 gsap-fade-in">
            ...
            <div className="absolute top-0 right-0 p-6 md:p-8">
              <span className="material-symbols-outlined text-primary text-2xl md:text-3xl font-light" style={{ fontVariationSettings: "'FILL' 0" }}>monitor_heart</span>
            </div>
            <div className="p-6 md:p-8 border-x border-b border-[rgba(132,149,136,0.2)]">
              <span className="font-mono text-primary text-[10px] block mb-2">[ SEÑAL_POLAR ]</span>
              <h3 className="font-serif text-2xl md:text-3xl font-light mb-3 md:mb-4">Fluctuación Borealis</h3>
          ...
          {/* Metrics Cluster */}
          <div className="md:col-span-7 md:mt-12 flex flex-col gap-8 md:gap-12 gsap-fade-in">
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-8 md:gap-12">
              <div className="glass-panel p-8 md:p-10 border border-[rgba(132,149,136,0.2)] relative cursor-pointer hover:bg-surface-variant transition-colors group">
                <div className="absolute top-0 left-0 w-8 h-[1px] bg-primary" />
                <div className="absolute top-0 left-0 w-[1px] h-8 bg-primary" />
                <h4 className="font-mono text-primary text-[10px] mb-6 md:mb-8 tracking-[0.2em] uppercase">Métricas de Vacío</h4>
              ...
              <div className="flex flex-col justify-center">
                <p className="font-serif text-lg md:text-xl italic text-on-surface/40 leading-relaxed mb-4 md:mb-6">"Los datos sugieren que el cielo no es una barrera, sino una membrana reactiva ante nuestra mera observación."</p>
                <span className="font-mono text-[9px] text-primary">— DR. ELARA VANCE, ARCHIVO SENTINEL</span>
              </div>
            </div>
            <div className="flex-grow group relative overflow-hidden min-h-[200px] md:min-h-[300px]">
              <img
              ...
              <div className="absolute inset-0 flex items-center justify-center pointer-events-none">
                <div className="text-center">
                  <h3 className="font-headline font-extralight text-3xl md:text-5xl tracking-[0.3em] uppercase opacity-20 group-hover:opacity-100 transition-opacity translate-y-4 group-hover:translate-y-0 duration-500 text-white">Invisibilidad</h3>
        ...
        <div className="flex flex-col items-center gap-8 md:gap-12 gsap-fade-in">
          <div className="w-px h-24 md:h-32 bg-gradient-to-b from-primary to-transparent" />
